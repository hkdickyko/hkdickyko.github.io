...
list(GET <list> <element index> [Kindex>...] <out-var>)list(JOIN <list〉 <glue〉 <out-var>)
...
```
list(APPEND <list> [Kelement>...])
list(FILTER <list> {INCLUDE | EXCLUDE) REGEX <regex>)
list(INSERT <list> <index> [Kelement>...])
list(POP_BACK <list> [Kout-var)...])
list(POP_FRONT <list> [Kout-var>...])
list(PREPEND <list> [Kelement>...])
...
get_filename_component(<VAR> <FileName> NAME ABSOLUTE)
get_filename_component(<VAR> <FileName> NAME_WE ABSOLUTE)
get_filename_component(<VAR> <FileName> NAME_WLE ABSOLUTE)
get_filename_component(<VAR> <FileName> EXT ABSOLUTE)
get_filename_component(<VAR> <FileName> LAST_EXT ABSOLUTE)
```
...
```
set_property(GLOBAL [APPEND] [APPEND_STRING] PROPERTY <name> [value1 [value2 ...]])
set_property(DIRECTORY [APPEND] [APPEND_STRING] PROPERTY <name> [value1 [value2 ...]])
set_property(TARGET [APPEND] [APPEND_STRING] PROPERTY <name> [value1 [value2 ...]])
set_property(SOURCE [APPEND] [APPEND_STRING] PROPERTY <name> [value1 [value2 ...]])
set_property(TEST [APPEND] [APPEND_STRING] PROPERTY <name> [value1 [value2 ...]])
set_property(CACHE [APPEND] [APPEND_STRING] PROPERTY <name> [value1 [value2 ...]])
```

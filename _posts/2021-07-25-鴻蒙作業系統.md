...
為了修改 **WINE** USB端口配置，請在運行 **HiBurn** 後使用的以下命令，然後再將控制板插入到電腦USB端口
```
...
```
$ nc -z -v -u 192.168.3.127 8888

Connection to 192.168.3.127 8888 port [udp/*] succeeded!
(IP:192.168.3.127, Port:8888) IP 及 Port 端口必須根據實際設置更改

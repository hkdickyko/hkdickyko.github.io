...
$$
v = \begin{bmatrix}0， v \end{bmatrix} ， q = \begin{bmatrix} cos\left(\frac{\theta}{2}\right)，sin\left(\frac{\theta}{2}\right) \cdot \begin{bmatrix}x \\ y \\ z\end{bmatrix} \end{bmatrix}
$$

...
$$
\begin{bmatrix} \bar{q_w} \\ \bar{q_x} \\ \bar{q_y} \\ \bar{q_z} \end{bmatrix}_t = 
\begin{bmatrix} 
q_w \\ q_x \\ q_y \\ q_z 
\end{bmatrix}_{t-1} + 
\frac {\Delta t}{2}
...
\bar{\omega_x} q_w+\bar{\omega_z} q_y- \bar{\omega_y} q_z\\
\bar{\omega_y} q_w-\bar{\omega_z} q_x+ \bar{\omega_x} q_z\\
\bar{\omega_z} q_w+\bar{\omega_y} q_x -\bar{\omega_x} q_y
\end{bmatrix}
$$

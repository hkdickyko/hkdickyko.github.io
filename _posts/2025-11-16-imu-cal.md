...
$$
\hat{g} = \begin{bmatrix} \hat{g_{x}} \\ \hat{g_{y}} \\ \hat{g_{z}}\end{bmatrix} = C_b^R \cdot \hat{g_R} \Rightarrow C_b^R \cdot \begin{bmatrix} 0 \\ 0 \\ 1\end{bmatrix}
$$
...
<font color="#FF0010">世界坐标系</font>下的理论磁场如下：
...
<font color="#FF0010">传感器坐标</font>下的理论地磁向量 $\hat{h}$ 如下：

...
q_y & q_z & q_w & -q_x \\
q_z & -q_y & q_x & q_w
\end{bmatrix} \cdot \begin{bmatrix} 0 \\ \omega_y \\ \omega_z \\ \omega_z \end{bmatrix}
$$
...
\omega_x q_w + \omega_zq_y - \omega_y q_z\\
\omega_y q_w - \omega_zq_x + \omega_x q_z\\
\omega_zq_w + \omega_y q_x -\omega_x q_y 
\end{bmatrix}
$$
...
$$
S_{\omega_t} = \begin{bmatrix} 0 \\ \omega \end{bmatrix}_t = \begin{bmatrix} 
...
$$
\begin{bmatrix} q_w \\ q_x \\ q_y \\ q_z \end{bmatrix}_t = 
\begin{bmatrix} 
q_w \\ q_x \\ q_y \\ q_z 
\end{bmatrix}_{t-1} + 
\frac {\Delta t}{2}
...
q_y & -q_z & q_w & q_x \\
q_z & q_y & -q_x & q_w
\end{bmatrix} \cdot \begin{bmatrix} 0 \\ \omega_y \\ \omega_z \\ \omega_z \end{bmatrix} \right )
$$

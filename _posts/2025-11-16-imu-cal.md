...
$$
\hat{v} = C_R^b \cdot g = \left ( C_b^R \right)^{-1} \cdot \begin{bmatrix} 0 \\ 0 \\ 1\end{bmatrix} = \begin{bmatrix}
2(q_xq_z + q_wq_y) \\
2(q_yq_z - q_wq_x) \\
...
$$
\frac{v_x}{2} = q_xq_z - q_wq_y\\
\frac{v_y}{2} = q_yq_z + q_wq_x\\
\frac{v_z}{2} = q_w^2+q_z^2-0.5
$$

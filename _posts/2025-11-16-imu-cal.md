...
$$
Output = K_p \times \begin{bmatrix} e_x \\ e_y \\ e_z \end{bmatrix} + K_i \times \int \begin{bmatrix} e_x \\ e_y \\ e_z \end{bmatrix} \cdot \Delta t + K_d \times \frac {1}{\Delta t} \cdot \left ( {\begin{bmatrix} e_x \\ e_y \\ e_z \end{bmatrix}}_{t} - {\begin{bmatrix} e_x \\ e_y \\ e_z \end{bmatrix}}_{t-1} \right )
$$

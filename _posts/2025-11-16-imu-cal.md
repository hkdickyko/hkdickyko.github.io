...
$$
\hat{g} = \begin{bmatrix} \hat{g_x} \\ \hat{g_y} \\ \hat{g_z} \end{bmatrix} = 
\begin{bmatrix}
q_w^2 \color{red}{+ q_x^2} - q_y^2 - q_z^2 & 2(q_xq_y \color{orange}{-} q_wq_z) & 2(q_xq_z \color{orange}{+} q_wq_y) \\
2(q_xq_y \color{orange}{+} q_wq_z) &  q_w^2 - q_x^2 \color{red}{+ q_y^2} - q_z^2 & 2(q_yq_z \color{orange}{-} q_wq_x) \\
2(q_xq_z \color{orange}{-} q_wq_y) & 2(q_yq_z \color{orange}{+} q_wq_x) &  q_w^2 - q_x^2 - q_y^2 \color{red}{+ q_z^2}
...
$$
\begin{bmatrix} 
\hat{g_x} \\ \hat{g_y} \\ \hat{g_z} 
\end{bmatrix} = 
\begin{bmatrix} 2(q_xq_z + q_wq_y) \\ 2(q_yq_z - q_wq_x) \\ 2(q_w^2+q_z^2-0.5) 
\end{bmatrix}
$$
...
，q_w^2+q_z^2 = \color{red}{-q_x^2-q_y^2+1} \\
q_w^2\color{red}{-q_x^2-q_y^2}+q_z^2 \Rightarrow  q_w^2+q_w^2+q_z^2-1+q_z^2 = -q_x^2-q_y^2 +1 -q_x^2-q_y^2
$$
...
$$
  \\
\color{red}{q_w^2}-q_x^2-q_y^2+\color{red}{q_z^2} \Rightarrow 
$$

...
$$
Output = \left ( K_p \times \begin{bmatrix} e_x \\ e_y \\ e_z \end{bmatrix} \right) + \left ( K_i \times \int \begin{bmatrix} e_x \\ e_y \\ e_z \end{bmatrix} \cdot \Delta t \right) + \left ( K_d \times \frac {{\begin{bmatrix} e_x \\ e_y \\ e_z \end{bmatrix}}_{t} - {\begin{bmatrix} e_x \\ e_y \\ e_z \end{bmatrix}}_{t-1}}{\Delta t} \right)
$$

...
即步进电机在空载情况下能够正常启动的脉冲频率，如果脉冲频率高于该值，电机不能正常启动，因当步进电机转动时，电机各相绕组的电感将形成一个反向电动势；频率越高，反向电动势越大。在它的作用下，电机随频率(或速度)的增大而相电流减小，从而导致力矩下降。力矩不足够转动步进电机。可能发生丢步或堵转。
...
$$
　　工作频率 = \textcolor{red}{减速比} \times 启动转速 \times \frac {360}{步进角度} = 5 \times N1 \times \frac {360}{A}
$$

所以应该看矩频特性曲线：坐标点[(T1)/5，5*(N1)*360/A]是不是在频特性曲线**自己动区域来內**。如果是則可以选择这个电机，否则要选择其它型号，因为这个电机会失步，或者根本就不能转动。

...
```
$ ffmpeg -f lavfi -i "color=c=white:s=256x256" -i input.mp4 -filter_complex "[1:v]colorkey=0x00FF00:0.3:0.2[ckout];[0:v][ckout]overlay=shortest=1[out]" -map [out] output.mp4
```

...
<html>
  ...
  <body>
    <svg id="container" width="500" height="500">
      <text id="t1" stroke="#ff0000">This is a test</text>
    </svg>
    <script>
      let cu = new drawSVG("container");
      cu.line("l2", 0, 0, 250, 250);
      cu.width = 10;
      cu.line("l3", 0, 0, 250, 0);
      cu.color = "#0000FF";
      cu.point("p1", 100, 100);
      cu.arc("arc1", 150, 150, 100, 70, 130);
      cu.width = 30;
      cu.color = "#00FF00";
      cu.line("l1", 150, 150, 250, 250);
      let points = [
        [150, 150],
        [100, 400],
        [400, 30],
      ...
      cu.rotate("svg", 10);
      cu.scale("svg", 0.5);
      cu.arc("c1", 0, 0, 100, 70, 150);
      cu.translate("c1", 150, 150);
      cu.rotate("c1", 45);
      cu.textPath("t1", "svg");
    </script>
  </body>

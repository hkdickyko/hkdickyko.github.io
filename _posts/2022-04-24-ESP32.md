...
請<font color="#FF1000">注意</font>以下項目:

  - 如<font color="#FF1000">編譯時出現問題</font>，請更新 Python 版本
  - 當刷機程式開始時，同時<font color="#FF1000">按下 RESET </font> 和 <font color="#FF1000">BOOT</font> 按鈕，然後先<font color="#FF1000">放開 RESET</font> 按鈕，然後<font color="#FF1000">再放開 BOOT</font> 按鈕。刷機時軟體才可以辨識硬體。

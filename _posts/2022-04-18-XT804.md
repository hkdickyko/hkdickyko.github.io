...
請<font color="#FF1000">注意</font>在使用 W806 的 SDK 下载烧录 <font color="#FF1000">W801</font> 时, 需要将 <font color="#FF1000">rules.mk</font> 中的 <font color="#FF1000">-rs</font> 参数修改一下, 从 <font color="#FF1000">at</font> 改为 <font color="#FF1000">rts</font>, 就能对 W801 开发板写入.

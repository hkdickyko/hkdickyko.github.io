...
<tr><td>读取数据<br>设置</td><td>I2C_SLV0_CTRL<br>0x05 [7]</td><td>写入</td><td>3</td><td>0x05, [0] << 7</td><td class ="left">1 – 从设备 0 读取数据，并将数据存储在 EXT_SENS_DATA_00 寄存器<br>0 – 禁用从设备 0 读取数据</td></tr>
<tr><td>读取数据<br>长度设置</td><td>I2C_SLV0_CTRL<br>0x05 [3:0]</td><td>写入</td><td>3</td><td>0x05, [3:0]</td><td class ="left">从机 0 读取的字节数长度</td></tr>

<tr><td>主接口<br>设置</td><td>USER_CTRL<br>0x03 [5]</td><td>写入</td><td>0</td><td>0x03, [0] << 5</td><td class ="left">1 – 启用 I2C 主接口模块<br>0 – 禁用 I2C 主接口模块</td></tr>

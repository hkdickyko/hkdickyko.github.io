...
sequenceDiagram;
   ...
   note over C: 0x7F, 3 << 4;
   C->>I: 设置设备库 3;
   note over C,A: check for idle slave<br/>I2C_SLV4_CTRL<br/>I2C_SLV4_EN [7];
   note over C,A: set slave addr<br/>I2C_SLV4_ADDR [6:0]<br/>I2C_SLV4_RNW [7]<br/>;
   note over C,A: set slave reg<br/>I2C_SLV4_REG [7:0];
   note over C,A: set output data on write<br/>I2C_SLV4_DO [7:0];
   note over C,A: start transaction<br/>I2C_SLV4_CTRL [7] <br/>I2C_SLV4_EN;
   note over C: wait 5ms;
   note over C: 0x7F, 3 << 4;
   C->>I: 设置设备库 0;
   note over C,A: get input data on read<br/>I2C_SLV4_DI [7:0];
   note over C,A: check status<br/>I2C_MST_STATUS<br/>I2C_SLV4_NACK [4]<br/>I2C_SLV4_DONE [6]<br/>;

...
## 从机 4 读取
 ...
 - addr = 0x0C \| 0x80 --- I2C_SLV_ADDR_READ
 - reg = 0x01 --- WIA2
...
sequenceDiagram;
   ...
   C->>I: 设置从机地址<br/>I2C_SLV4_ADDR [6:0]<br/>I2C_SLV4_RNW [7]<br/>;
   note over C: 0x13, 0x8C;
   C->>I: 设置从机注册表<br/>I2C_SLV4_REG [7:0];
   note over C: 0x14, 0x01;
   rect rgb(255,125,125);
   C->>I: 启动交易流程<br/>I2C_SLV4_CTRL [7] <br/>I2C_SLV4_EN;
   note over C: 0x15, (1 << 7);   
   C-->I: 等待 5ms;
   note over C: delay(5);
   C->>I: 读取要求数据<br/>I2C_SLV4_DI [7:0];
   note over C: 0x17;
   A-->>C: 读取值;
...
sequenceDiagram;
   ...
   C->>I: 检查从机 4 是否空闲<br/>I2C_SLV4_CTRL<br/>I2C_SLV4_EN [7];
   note over C: 读取值 & (1 << 7);
   C->>I: set slave addr<br/>I2C_SLV4_ADDR [6:0]<br/>I2C_SLV4_RNW [7]<br/>;
   note over C: 0x13, 0x0C;
   C->>I: set slave reg<br/>I2C_SLV4_REG [7:0];
   note over C: 0x14, 0x31;
   rect rgb(255,125,125);
   C->>I: set output data on write<br/>I2C_SLV4_D0 [7:0];
   note over C: 0x16, 0x08;
   C->>I: start transaction<br/>I2C_SLV4_CTRL [7] <br/>I2C_SLV4_EN;
   note over C: 0x15, (1 << 7); 
   C-->I: 等待 5ms;
   note over C: delay(5);
   end;
   C->>I: 设置设备库 0;
   note over C: 0x7F, 0 << 4;
   I->>C: check status<br/>I2C_MST_STATUS<br/>I2C_SLV4_NACK [4]<br/>I2C_SLV4_DONE [6]<br/>;
   note over C: 0x17;
   A-->>C: 读取值; 
   note over C: 读取值 & (1 << 4) != 0;
   note over C: 读取值 & (1 << 6) == 0;  
...
sequenceDiagram;
   ...
   C->>I: 设置设备库 3;
   note over C: 0x7F, 3 << 4;
   C->>I: set slave addr<br/>I2C_SLV0_ADDR [6:0]<br/>I2C_SLV0_RNW [7]<br/>;
   note over C: 0x03, 0x0C | (1 << 7);
   C->>I: set slave reg<br/>I2C_SLV4_REG [7:0];
   note over C: 0x14, 0x11;
   C->>I: set slave  Control<br/>I2C_SLV0_CTRL [7:0];

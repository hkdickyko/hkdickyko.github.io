...
|设置陀螺仪<br>采样率|GYRO_SMPLRT_DIV<br>0x00 [7:0] |读出|2|0x00|此寄存器仅在 FCHOICE = 1'b1<br>(FCHOICE_B 寄存器位为 1'b0)<br>且 (0<DLPF_CFG<7) 时有效。<br>ODR 计算如下:<br>$rate = \frac{1100}{1+GYRO\_SMPLRT\_DIV}H_z$|

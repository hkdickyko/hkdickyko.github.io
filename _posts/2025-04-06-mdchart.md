...
<tr><td>陀螺仪<br>低通滤波器</td><td>GYRO_CONFIG_1<br>0x01<br>GYRO_DLPFCFG [5:3]</td><td>写入</td><td>2</td><td>0x01, [2:0] << 3</td><td><table><tr><thead><th>[2:0]</th><th>3dB带宽<br>Hz</th><th>NBW带宽<br>Hz</th></thead></tr><tbody><tr><td>0</td><td>196.6</td><td>229.8</td></tr><tr><td>1</td><td>151.8</td><td>187.6</td></tr><tr><td>2</td><td>119.5</td><td>154.3</td></tr><tr><td>3</td><td>51.2</td><td>73.3</td></tr><tr><td>4</td><td>23.9</td><td>35.9</td></tr><tr><td>5</td><td>11.6</td><td>17.8</td></tr><tr><td>6</td><td>5.7</td><td>8.9</td></tr><tr><td>7</td><td>361.4</td><td>376.5</td></tr></tbody></table>陀螺仪读写 GYRO_FCHOICE = 1</td></tr>
...
<tr><td>速度计<br>低通滤波器</td><td>ACCEL_CONFIG<br>0x14<br>ACCEL_DLPFCFG [5:3]</td><td>写入</td><td>2</td><td>0x14, [2:0] << 3</td><td><table><th>[2:0]</th><th>3dB带宽<br>Hz</th><th>NBW带宽<br>Hz</th><tr><td>0</td><td>246.0</td><td>265.0</td></tr><tr><td>1</td><td>246.0</td><td>265.0</td></tr><tr><td>2</td><td>111.4</td><td>136.0</td></tr><tr><td>3</td><td>50.4</td><td>68.8</td></tr><tr><td>4</td><td>23.9</td><td>34.4</td></tr><tr><td>5</td><td>11.5</td><td>17.0</td></tr><tr><td>6</td><td>5.7</td><td>8.3</td></tr><tr><td>7</td><td>473</td><td>499</td></tr></table>速度计读写 ACCEL_FCHOICE = 1</td></tr>
...
<tr><td>多主设备<br>设置</td><td>I2C_MST_CTRL<br>0x01<br>MULT_MST_EN [7]</td><td>写入</td><td>3</td><td>0x01, [1] << 7</td><td class="left"> 1 = 启用多主设备功能<br> 0 = 禁用不使用 I2C_MST_IF 的时钟，并且禁用检测仲裁失败的逻辑</td></tr>
...
<tr><td>从机读写<br>设置</td><td>I2C_SLV0_ADDR<br>0x03<br>I2C_SLV0_RNW [7]</td><td>写入</td><td>3</td><td>0x03, [1] << 7</td><td class ="left">1 = 传输为读取<br>0 = 传输为写入</td></tr>
...
<tr><td>主接口<br>重置</td><td>USER_CTRL<br>0x03<br>I2C_MST_RST [1]</td><td>写入</td><td>0</td><td>0x03, [0] << 1</td><td class ="left">1 – 重置主模块。异步复位。一个时钟周期 (20 MHz) 后自动清除。
注意：此位必须在主模块挂起时设置。否则从模块将被锁定，这将需要主机复位从模块。</td></tr>
</table>
...
|读取数据<br>设置|I2C_SLV0_CTRL<br>0x05 [7]|写入|3|0x05, [0] << 7|1 – 从设备 0 读取数据，并将数据存储在 EXT_SENS_DATA_00 寄存器<br>0 – 禁用从设备 0 读取数据|
|主接口<br>设置|USER_CTRL<br>0x03 [5]|写入|3|0x03, [0] << 5|1 – 启用 I2C 主接口模块<br>0 – 禁用 I2C 主接口模块|
|输出数据<br>速率对齐|ODR_ALIGN_EN<br>0x09 [0]|写入|2|0x09, [0] |0 = 禁用输出数据速率启动时间对齐<br>1 = 启用输出数据速率时间对齐：<br> GYRO_SMPLRT_DIV<br>ACCEL_SMPLRT_DIV_1<br>CCEL_SMPLRT_DIV_2<br>I2C_MST_ODR_CONFIG|

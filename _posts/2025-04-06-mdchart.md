...
<tr><td>数据输出<br>设置</td><td>I2C_SLV4_DO<br>0x16 [7:0]</td><td>写入</td><td>3</td><td>0x16, [7:0]</td><td class ="left">当从机 4 设置为写入时，数据输出</td></tr>

<tr><td>数据输出<br>设置</td><td>I2C_SLV4_DI<br>0x17 [7:0]</td><td>读取</td><td>3</td><td>0x17, [7:0]</td><td class ="left">当从机 4 设置为写入时，数据读取</td></tr>
...
---
  Slave Addr      MAG_I2C_ADDR    0x0C
  Magnetometer    MAG_WIA2		    0x01
...
sequenceDiagram;
   ...
   note over C: 0x13, 0x0C & (0 << 7);
   C->>I: set slave reg<br/>I2C_SLV4_REG [7:0];
   note over C: 0x14, 0x01;   
   C->>I: set output data on write<br/>I2C_SLV4_DO [7:0];
   note over C: 0x16, 0; 
   ...
   C->>I: 设置设备库 3;
   note over C: 0x7F, 3 << 4;
   C->>I: get input data on read<br/>I2C_SLV4_DI [7:0];
   note over C: 0x7F, 3 << 4;

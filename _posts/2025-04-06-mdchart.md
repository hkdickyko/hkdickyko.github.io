...
<tr><td>读取数据</td><td>EXT_SLV_SENS_DATA_00<br>0x3B [7:0]</td><td>读取</td><td>0</td><td>0x3B</td><td>通过主接口从外部设备读取传感器数据</td></tr>
...
|读取数据|EXT_SLV_SENS_DATA_00<br>0x3B [7:0]|读取|0|0x3B |通过主接口从外部设备读取传感器数据|

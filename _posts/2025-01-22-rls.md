...
$$
\color{red} Y \color{black} = \color{orane} X \color{red} b \color{black} => \\
X^T\color{red} Y \color{black} = X^T \color{red} Xb \color{black}=> \\
\color{red} b \color {black} = (X^TX)^{-1}X^T\color{red} Y \color{black}
$$

...
function multiplyBy()
{
  num1 = document.getElementById("Resistance").value;
  num2 = document.getElementById("Capacitance").value;
  document.getElementById("result").value = '計算時間常數: " + (num1 * num2).toString(2);
}
</script>
...
<form>
電阻值: <input type="text" id="Resistance" /> (Ω)<br>
電容值: <input type="text" id="Capacitance" /> (F)<br>

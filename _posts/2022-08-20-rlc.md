...
注意: <font color="#FF1000">0.7 τ</font> 相等於 <font color="#FF1000">50%</font> 電壓 (E)
...
function resonance()
{
  let L=document.getElementById("iValue").value;
  let C=document.getElementById("cValue").value;
  let value=1/(2*Math.PI*Math.sqrt(L*C/1000000000000));
  document.getElementById("rValue").value = "計算諧振頻率: " + Math.round(value).toString() + " Hz";
}
</script>
...
function coilCalulate()
{
  ...
  let radius=dia/2;
  let length=document.getElementById("lengthValue").value/1000;
  ...
  let value=1000000*k*m0*m1*Sr*coils*coils/length;
  document.getElementById("coilResult").value = "計算電感值: " + Math.round(value).toString() + " μH";
}
</script>

<table class="inputT">
<tr><td>線圈直徑:</td><td><input type="text" id="diaValue" /></td><td>(mm)</td></tr>
<tr><td>線圈長度:</td><td><input type="text" id="lengthValue" /></td><td>(mm)</td></tr>
<tr><td>線圈圈數:</td><td><input type="text" id="coilValue" /></td><td></td></tr>
<tr><td>相對磁導率:</td><td><input type="text" id="mValue" /></td><td></td></tr>

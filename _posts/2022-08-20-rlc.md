...
<div class="form"><form>
電阻值: <input type="text" id="Resistance" /> (kΩ)<br>
電容值: <input type="text" id="Capacitance" /> (μF)<br>
<input id="result" type="button" onClick="multiplyBy()" Value="計算時間常數" />
</form></div>
...
<div class="form"><form>
<span id="resonspan">電容值: </span><input type="text" id="cValue" /> (μF)<br>
<span id="resonspan">電感值: </span><input type="text" id="iValue" /> (μH)<br>
<input id="rValue" type="button" onClick="resonance()" Value="計算諧振頻率" />
</form></div>

...
<tr><td>銅線直徑:</td><td><input type="text" id="wireValue" /></td><td>(mm)</td></tr>
<tr><td>相對磁導率:</td><td><input type="text" id="mValue" value=1 /></td><td></td></tr>

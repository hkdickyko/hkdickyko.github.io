...
function resonance()
{
  ...
  let value=1/(2*math.pi()*math.sqrt(num1*num2/1000000000));
  document.getElementById("rValue").value = "計算諧振頻率" + value.toString() + "Hz";
}
</script>
...
電阻值: <input type="text" id="Resistance" /> (kΩ)<br>
電容值: <input type="text" id="Capacitance" /> (μF)<br>
電感值: <input type="text" id="Inductance" /> (mH)<br>

...
解释液晶屏地址，事实上往 DDRAM 里的 00H 地址处送一个数据，譬如 0x31 并不能显示 **1** 出来。这是一个很容易出错的地方，原因就是如果想在 DDRAM 的 00H 地址处显示数据，则必须将 00H 加上 **<font color="#FF1000">80H</font>**，即 80H，若要在 DDRAM 的 01H 处显示数据，则必须将 01H 加上 80H 即 81H。依次类推。

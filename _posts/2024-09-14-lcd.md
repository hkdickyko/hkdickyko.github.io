...
void lcd_move_string_right(bool right, int length, int delay_ms) 
{ 
  int shift = length; 
  if(right)
  {
...
printf("I2C initialized successfully...\n");
  ...
  lcd_move_string_right(true, 16, 200);
  lcd_move_string_right(false, 16, 200);

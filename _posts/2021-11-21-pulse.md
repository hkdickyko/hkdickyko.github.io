...
def initModule():
    ...
    initFIFO()
        ...
        ( REG_FIFO_CONFIG, 0X0F )  # sample avg: 1, fifo rollover: 0, fifo almost full: 17

    spo2Mode()    
    setSPO2(adc_range=ADC_4096, sample_rate=SRATE_100, led_pw=PWIDTH_411)
    redLed(7)
    irLed(7)

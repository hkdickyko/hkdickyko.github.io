...
|正規化截止頻率 ( $ \Delta f_{c} $ ) | $ \Delta f_{c} = \frac{F_{c}}{f_{s}} $ | $ \Delta f_{c} = \frac { {2\times{10^3}} +500}{10\times{10^3}} = {\color{Purple}{0.25}} $ |
...
$$ h_{D}[0] = \frac {\omega_{c}} {\pi} = \frac {\color{Purple}{0.25}}{pi} = 0.07958 $$  

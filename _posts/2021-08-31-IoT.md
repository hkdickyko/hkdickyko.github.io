...
- ampy --port /dev/ttyUSB0 --baud 115200 rm "abc"

創建目錄

- ampy --port /dev/ttyUSB0 --baud 115200 mkdir "abc"

删除目录

- ampy --port /dev/ttyUSB0 --baud 115200 rmdir "abc"

上傳目錄文件 

- ampy --port /dev/ttyUSB0 --baud 115200 put src.py dest.py

下載目錄文件

- ampy --port /dev/ttyUSB0 --baud 115200 get src.py dest.py

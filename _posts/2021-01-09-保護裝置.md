...
![](../assets/img/ele/fuse.png){style="max-width:90%"}
...
![](../assets/img/ele/lte.png){style="max-width:90%"}
...
## MCB characteristic
![](../assets/img/ele/mcb.png){style="max-width:90%"}
...
![](../assets/img/ele/trip.jpg){style="max-width:90%"}

## MCCB chararcteristic
![](../assets/img/ele/mccb.png){style="max-width:90%"}
...
![](../assets/img/ele/mccbtable.jpg){style="max-width:90%"}

![](../assets/img/ele/mccbcharacteristic.jpg){style="max-width:90%"}

## Currnt level for protective devices

![](../assets/img/ele/cable.png){style="max-width:90%"}

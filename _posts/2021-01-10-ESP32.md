...
The procedure as below:
 ...
 - to go into flash mode,     
    - <font color="#FF1000">press and hold the Boot button, 
    - press the Reset button shortly</font> (about half a second is fine). 
    - Boot button was held for a few more seconds, and then release it. 

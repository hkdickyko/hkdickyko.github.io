...
當 $ M_{y}\leq{0} $ 即<font color="#FF0010">180</font>至<font color="#FF0010">360</font>度如下

$$ M{\varphi}=2\times\pi+\arctan\left(\frac{M_{y}}{M_{x}}\right) = 2\times\pi+atan2(M_{y}, M_{x}) $$

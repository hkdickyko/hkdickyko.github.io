...
q_x = \frac {C_{32} - C_{23}}{4 q_w}，
q_y = \frac {C_{13} - C_{31}}{4 q_w}，
q_z = \frac {C_{21} - C_{12}}{4 q_w}\\
if T \le 0 \; and \; C11 \; largest： 
q_x = \frac {1}{2} \sqrt {1 + C_{11} - C_{22} - C_{33}}，
q_w = \frac {C_{32} - C_{23}}{4 q_x}，
q_y = \frac {C_{12} - C_{21}}{4 q_x}，
q_z = \frac {C_{13} - C_{31}}{4 q_x}\\
if T \le 0 \; and \; C22 \; largest： 
q_y = \frac {1}{2} \sqrt {1 - C_{11} + C_{22} - C_{33}}，
q_w = \frac {C_{13} - C_{31}}{4 q_y}，
q_x = \frac {C_{12} - C_{21}}{4 q_y}，
q_z = \frac {C_{23} - C_{32}}{4 q_y}\\
if T \le 0 \; and \; C33 \; largest： 
q_z = \frac {1}{2} \sqrt {1 - C_{11} - C_{22} + C_{33}}，
q_w = \frac {C_{21} - C_{12}}{4 q_z}，
q_x = \frac {C_{13} - C_{31}}{4 q_z}，
q_y = \frac {C_{23} - C_{32}}{4 q_z}
$$

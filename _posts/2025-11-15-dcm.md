...
$$
C_{31} \neq \pm 1， \\
\psi = tan^{-1} \frac {C_{32}} {C_{33}} \\
\phi = -sin^{-1} c_{31} \\
\theta = tan^{-1} \frac {C_{21}} {C_{11}}  
$$
...
$$
q_w = \sqrt{\frac{1}{4} \left( 1 + C_{11} - C_{22} - C_{33} \right)}，
q_x = \sqrt{\frac{1}{4} \left( 1 - C_{11} + C_{22} - C_{33} \right)}，
q_y = \sqrt{\frac{1}{4} \left( 1 - C_{11} - C_{22} + C_{33} \right)}，
q_z = \sqrt{\frac{1}{4} \left( 1 + C_{11} + C_{22} + C_{33} \right)}，
$$

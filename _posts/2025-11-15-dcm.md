...
|:---:|:---:|:---:|:---:|:---:|
|$T>0$|$q_w$|$\frac {1}{2} \sqrt {1 + T}$|$\frac {C_{32} - C_{23}}{4 q_w}$|$\frac {C_{13} - C_{31}}{4 q_w}$|$\frac {C_{21} - C_{12}}{4 q_w}$|
|$T≤0$|$q_x$|$\frac {C_{32} - C_{23}}{4 q_x}$|$\frac {1}{2} \sqrt {1 + C_{11} - C_{22} - C_{33}}$|$\frac {C_{12} - C_{21}}{4 q_x}$|$\frac {C_{13} - C_{31}}{4 q_x}$|
|$T≤0$|$q_y$|$\frac {C_{13} - C_{31}}{4 q_y}$|$\frac {C_{12} - C_{21}}{4 q_y}$|$\frac {1}{2} \sqrt {1 - C_{11} + C_{22} - C_{33}}$|$\frac {C_{23} - C_{32}}{4 q_y}$|
|$T≤0$|$q_z$|$\frac {C_{21} - C_{12}}{4 q_z}$|$\frac {C_{13} - C_{31}}{4 q_z}$|$\frac {C_{23} - C_{32}}{4 q_z}$|$\frac {1}{2} \sqrt {1 - C_{11} - C_{22} + C_{33}}$|

...
### 罗德里格旋转公式 (Rodrigues' rotation formula) 计算出四元数
 ...
 2. 计算旋转轴 (根据公式 9)：
     ...
     - <font color="#FF1000">注意</font>一定要归一化叉积的计算结果，否则在最终计算中会出错。
...
**注**：计算结果已是最终四元数，不需要用归一化处理，但之前在步骤 <font color="#FF0010"><b>1</b></font> 及 <font color="#FF0010"><b>2</b></font> 的归一化处理不可忽略否则会出错。

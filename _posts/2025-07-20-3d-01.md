...
$$
q = quaternion(w, ax, by,cz) = \begin{matrix}w=cos(\frac {angle}{2})\\ a=sin(\frac {angle}{2}) \cdot axis.x\\ b=sin(\frac {angle}{2}) \cdot axis.y\\ c=sin(\frac {angle}{2}) \cdot axis.z \end{matrix})
$$

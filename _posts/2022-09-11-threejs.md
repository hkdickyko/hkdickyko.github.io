...
![Alt text](../assets/img/3d/f15.gif)

<video style="width:100%;max-height:100%" autoplay muted loop controls preload="auto"><source src="../assets/img/3d/f15.mp4" type="video/mp4"></video>

<video src="../assets/img/3d/f15.mp4" width="100%" controls preload></video>
...
![Alt text](../assets/img/3d/facetype.gif)

![Alt text](../assets/img/3d/textanim.gif)

...
$$
C_R^b = \begin{bmatrix}
 q_w^2 \color{red}{+ q_x^2} - q_y^2 - q_z^2 & 2(q_xq_y \color{teal}{-} q_wq_z) & 2(q_xq_z \color{teal}{+} q_wq_y) \\
2(q_xq_y \color{teal}{+} q_wq_z) &  q_w^2 - q_x^2 \color{red}{+ q_y^2} - q_z^2 & 2(q_yq_z \color{teal}{-} q_wq_x) \\
2(q_xq_z \color{teal}{-} q_wq_y) & 2(q_yq_z \color{teal}{+} q_wq_x) &  q_w^2 - q_x^2 - q_y^2 \color{red}{+ q_z^2}
\end{bmatrix}
$$

...
$$
绕Y轴转(PITCH) = \theta_Y = -tan^{-1} (\frac {x_{acc}}{\sqrt{{y_{acc}}^2+{z_{acc}}^2}})
$$
...
```
=======
<font color="#FF1000">零偏校准</font>：可以通过平均值克服。让测量得到的数据比较平稳，不会有大幅度的跃动。比如测量 <font color="#FF1000">100</font> 次得到数值再取其平均值。
如傳感器为静止。所得每个轴的平均值为每个轴补偿的偏移量。

<font color="#FF1000">比例校准</font>：

<font color="#FF1000">刻度校准</font>：
>>>>>>> f0df4164c4e23c8ec847fc7805fcff018814408f

...
|1|0|X|地址控制<br/>第7位元6页面地址顺序<br/>0 = 从上到下<br/>1 = 从下到上<br/>第6位元-列地址顺序<br/>0 = 从左到右<br/>1 = 从右到左<br/>第5位元-页面/列顺序<br/>0 = 正常模式<br/>1 = 反向模式<br/>第4位元-行地址顺序<br/>
0 = LCD 从上到下刷新<br/>1 = LCD 从下到上刷新<br/>第3位元-RGB/BGR 顺序<br/>0 = RGB<br/>1 = BGR<br/>第2位元-显示数据锁存数据顺序<br/>0 = LCD 从左到右刷新<br/>1 = LCD 从右到左刷新|
|0|0|0x37|设定卷动列数|

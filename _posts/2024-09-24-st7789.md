...
|0|0|0x10/0x11|设定休眠模式<br/>0x00 = 关闭<br/>0x01 = 开启|
|0|0|0x20/0x21|设定负片模式<br/>0x00 = 关闭<br/>0x01 = 开启|
|0|0|0x26|设定Gamma修正|
|1|0|X|(1位元组设定值)|
|0|0|0x28/0x29|设定荧幕状态<br/>0x00 = 关闭<br/>0x01 = 开启|
|0|0|0x2A|设定写入栏的范围
...
|0|0|0x34/0x35|设定画面撕裂模式<br/>0x00 = 关闭<br/>0x01 = 开启|
|0|0|0x37|设定卷动列数|
|1|0|X|第1位元组为第15位元至第8位元<br/>第2位元组为第7位元至第0位元<br/>(2位元组 设定值)|
|0|0|0x38/0x39|	设定闲置模式<br/>0x00 = 关闭<br/>0x01 = 开启|

...
<table class="inputT">
<tr><td>a:</td><td><input type="text" id="a" value=1 /></td></tr>
<tr><td>b:</td><td><input type="text" id="b" value=1 /></td>j</tr>
<tr><td>c:</td><td><input type="text" id="c" value=1 /></td></tr>
<tr><td>d:</td><td><input type="text" id="d" value=1 /></td>j</tr>
...
<tr><td>Y:</td><td><input type="text" id="Y" /></td>j</tr>
</table>

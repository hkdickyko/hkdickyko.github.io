...
$$ X_0 = \frac {-1}{2\pi f_\omega C_0} $$

$$  Z_0 = R_0 + X_0 j = R_0 - \frac{1}{2\pi f_\omega C_0} j $$

### 計算阻抗: 阻抗並聯電阻

$$ \frac {1}{Z_1} = \frac {1}{R_1} + \frac {1}{Z_0} $$

$$ Z_1 = R_1 \parallel Z_0 = \frac {R_1 Z_0}{Z_0 + R_1} $$
...
$$ R_0 = 1000Ω, C_0 = 1 \mu F $$

$$ X_0 = \frac {-1}{2\pi f_\omega C_0} = -2449.5j$$

$$ Z_0 = R_0 + X_0 = 1000 - 2449.5j $$

$$ \phi_0 = tan^{-1} \left ( \frac{X}{R}\right ) $$

$$ \phi_1 = tan^{-1} (\frac{-2449.5}{1000}) = \color{Red}{67.79°} $$

$$ R_1 = 1000Ω, C_1 = 1 \mu F $$

$$ R_1 \parallel Z_0 = R_1 \parallel  1000 - 2449.5j = \frac {1000 \times (1000-2449.5j)}{1000 - 2449.5j + 1000} $$

$$ \frac {1000000-2449500j)}{2000 - 2449.5j} = 800- 244.95j $$

$$ Z_1 = 800 - 244.95j + -2449.5j = 800 - 2694.45j $$

$$ \phi_1 = tan^{-1} \left ( \frac{X}{R}\right ) $$

$$ \phi_1 = tan^{-1} (\frac{-2694.45}{800}) - tan^{-1}(\frac{-244.95}{800}) $$

$$ \phi_1 = -73.46° - (-17.02°) = \color{Red}{56.44°} $$

$$ R_2 = 1000Ω, C_2 = 1 \mu F $$

$$ R_2 \parallel Z_1 = R_1 \parallel  800 - 2694.45j = \frac {1000 \times (800 - 2694.45j)}{800 - 2694.45j + 1000} $$

$$ \frac {800000-2694450j}{1800 - 2694.45j} = 828.57 - 256.61j $$

$$ 828.57 - 256.61j + -2449.5j = 828.57 - 2706.11j $$

$$ \phi_2 = tan^{-1} \left ( \frac{X}{R}\right ) $$

$$ \phi_2 = tan^{-1} (\frac{-2706.11}{828.57}) - tan^{-1}(\frac{-256.61}{828.57}) $$

$$ \phi_2 = -72.98° - (-17.21°) = \color{Red} {55.77°} $$
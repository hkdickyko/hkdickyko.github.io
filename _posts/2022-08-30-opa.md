...
$$ P_1 = R_2 \parallel Z_1 = 1000 \parallel  1000 - 2449.5j $$
...
$$ Z_2 = P_1 + X_c = 800 - 244.95j + \color{Green}{-2449.5j} $$
...
$$ P_2 = R_3 \parallel Z_2 = 1000 \parallel  800 - 2694.45j $$
...
$$ Z_3 = P_2 + X_c = 828.57 - 256.61j + \color{Green}{-2449.5j}$$
...
$$ Z_1 = R_1 + X_{c1} = \sqrt {R_1^2 + X_{c1}^2} = 1414.2Ω $$

$$ Z_2 = R_2 // X_{c2} = \frac {R_2X_{c2}} {R_2 + X_{c2}} = \frac {1000 \times 1000j}{1000+1000j} = 707.1 $$

$$ f_{gain} = \frac {Z_2}{Z_1} = \frac {707.1}{1414.21 + 707.1} = \frac {1}{3} $$

...
function multiplyBy9()
{
  ...
  document.getElementById("result_9").value = "Φ: " + value.toFixed(1) + "°";
}
...
function multiplyBy10()
{
  ...
  let Z = X2*X2+Y2*Y2;
  let X = (X1*X2+Y1*Y2)/Z;
  let Y = (X2*Y1-X1*Y2)/Z; document.getElementById("X0").value = X.toFixed(2); document.getElementById("Y0").value = Y.toFixed(2);
}
</script>

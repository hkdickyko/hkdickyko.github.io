...
function multiplyBy7()
{
  ...
  if (value > 10000){
     value = value / 1000;
     document.getElementById("result_7").value = "Xc: " + value.toFixed(0) + " kΩ";
  }else
     document.getElementById("result_7").value = "Xc: " + value.toFixed(0) + " Ω";
}
...
function multiplyBy8()
{
  ...
  let C = parseFloat(document.getElementById("C8").value)/1000000;
  let value = 1 / (2*Math.PI*f*C);
  value = Math.sqrt(R*R + value*value);
if (value > 10000){
     value = value / 1000;
     document.getElementById("result_8").value = "Z₀: " + value.toFixed(0) + " kΩ";
  }else
     document.getElementById("result_8").value = "Z₀: " + value.toFixed(0) + " Ω";
}
...
let f = parseFloat(document.getElementById("fw").value);
  ...
  let eR = Math.sqrt(R*R+Xc*Xc)/1000;
  let value = 180*Math.atan(1 / (2*Math.PI*f*R*C))/Math.PI; document.getElementById("result_9").value = "Φ: " + value.toFixed(1) + "°";
}
...
function multiplyBy10()
{
  ...
  let X = (X1*X2 + Y1*Y2)/Z;
  let Y = (X2*Y1 - X1*Y2)/Z;
  document.getElementById("X0").value =  X.toFixed(2)
  document.getElementById("Y0").value =  Y.toFixed(2);
}
...
$$  \frac {Z_1}{Z_2} = \frac {x_1+j y_1} {x_2+j y_2} $$

$$  \frac {Z_1}{Z_2} = \frac {{x_1x_2}+{y_1y_2}}{{x_2^2 +  y_2^2}} + j\frac {{x_2y_1}-j{x_1y_2}} {{x_2^2+y_2^2}} $$

$$  Z_o = X_0 + j Y_0 $$

$$  X_0 = \frac {{x_1x_2}+{y_1y_2}}{{x_2^2+y_2^2}}$$

$$  Y_0 = \frac {{x_2y_1}-j{x_1y_2}}{{x_2^2+y_2^2}} $$

<table class="inputT">
<tr><td>X:</td><td><input type="text" id="X1" value=1 /></td></tr>
<tr><td>Y:</td><td><input type="text" id="Y1" value=1 /></td></tr>
<tr><td>X:</td><td><input type="text" id="X2" value=1 /></td></tr>
<tr><td>Y:</td><td><input type="text" id="Y2" value=1 /></td></tr>
<tr><td colspan=3><input id="result_10" type="button" onClick="multiplyBy10()" Value="計算值" /></td></tr>
</table>

<table class="inputT">
<tr><td>X:</td><td><input type="text" id="X0" value=1 /></td></tr>
<tr><td>Y:</td><td><input type="text" id="Y0" value=1 /></td></tr>
</table>

...
$$ Z_1 = R_1 + X_{c1} = \sqrt {R_1^2 + X_{c1}^2} = 1414.21Ω $$

$$ Z_2 = R_2 // X_{c2} = \frac {R_2X_{c2}} {R_2 + X_{c2}} = \frac {1000 \times 1000}{1000+1000} = 500 $$

$$ f_{gain} = \frac {Z_2}{Z_1} = \frac {500}{1414.21 + 500} = 3 $$

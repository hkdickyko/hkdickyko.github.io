...
{
  let R = parseFloat(document.getElementById("R7").value);
  let C = parseFloat(document.getElementById("C7").value);
  let value = 1000 / (2*Math.PI*R*C*Math.sqrt(6));
  let Rf = 29 * R; document.getElementById("result_7").value = "計算值: " + value.toFixed(0) + "Hz, R₁: " + Rf.toFixed(0) + " kΩ";
}
</script>

<table class="inputT">
<tr><td>R:</td><td><input type="text" id="R7" value=1 /></td><td>(kΩ)</td></tr>
<tr><td>C:</td><td><input type="text" id="C7" value=1 /></td><td>(μF)</td></tr>
...
{
  let R = parseFloat(document.getElementById("R8").value);
  let C = parseFloat(document.getElementById("C8").value);
let f = parseFloat(document.getElementById("fw").value);
  let Xc = 1000000 / (2*Math.PI*f*C);
  let eR = Math.sqrt(R*R+Xc*Xc)/1000;
  let value = 180*Math.atan(1000 / (2*Math.PI*f*R*C))/Math.PI; document.getElementById("result_8").value = "Z₀: " + eR.toFixed(2) + " kΩ, 相角: " + value.toFixed(1) + "°";
}
</script>
...
<tr><td>$f_ω$:</td><td><input type="text" id="fw" value=1 /></td><td>(Hz)</td></tr>

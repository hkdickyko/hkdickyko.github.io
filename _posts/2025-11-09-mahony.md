...
$$
a_{real} = \begin{bmatrix} a_{rx}  \\ a_{ry} \\ a_{rz} \end{bmatrix} = {\begin{bmatrix} K_{11} && K_{12} && K_{13} \\ K_{21} && K_{22} && K_{23} \\ K_{31} && K_{32} && K_{33}s \end{bmatrix}}^{-1} \begin{bmatrix} a_{x} - b_{ax} - 0 \\ a_{y} - b_{ay} - 0 \\ a_{z} - b_{az} - 0 \end{bmatrix}
$$
...
$$
h_{measure} = \begin{bmatrix} h_{x} \\ h_{y} \\ h_{z} \end{bmatrix} = \begin{bmatrix} M_{11} && M_{12} && M_{13} \\ M_{21} && M_{22} && M_{23} \\ M_{31} && M_{32} && M_{33} \end{bmatrix} \begin{bmatrix} h_{rx} \\ h_{ry} \\ h_{rz} \end{bmatrix} + \begin{bmatrix} b_x \\ b_y \\ b_z \end{bmatrix}
$$

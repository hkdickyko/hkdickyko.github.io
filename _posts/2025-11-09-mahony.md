...
$$
\begin{bmatrix} row_x \\ pitch_y \\ yaw_z \\ \end{bmatrix} = \begin{bmatrix} \theta \\ \phi \\ \psi \\ \end{bmatrix} = \begin{bmatrix} tan2^{-1} \left (\frac{2(yz+wx)}{1-2(x^2+y^2)} \right) \\ 
2 \cdot tan2^{-1} \left (\frac{\sqrt{1+2(wy-xz)}}{\sqrt{1-2(wy-xz)}}\right) - \frac{\pi}{2}
\\ tan2^{-1} \left (\frac{(2(xy+wz)}{1-2(y^2+z^2)} \right) \\ \end{bmatrix}
$$

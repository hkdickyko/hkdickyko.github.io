...
$$
\theta_{x} = \begin{bmatrix} 1 & 0 & 0 \\ 0 & Cos(\theta) & -sin(\theta)\\ 0 & sin(\theta) & Cos(\theta) \end{bmatrix}， \\ \phi_{y} = \begin{bmatrix} Cos(\phi) & 0 & sin(\phi)\\ 0 & 1 & 0 \\ -sin(\phi) & 0 & Cos(\phi) \end{bmatrix}， \\ \psi_{z} = \begin{bmatrix} Cos(\psi) & -sin(\psi) & 0\\ sin(\psi) & Cos(\psi) & 0\\ 0 & 0 & 1 \end{bmatrix}，
$$

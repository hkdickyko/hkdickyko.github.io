...
$$
+9.81 = S (a_{z0} - b_{az}) \\ -9.81  = S (a_{z1} - b_{az})
$$

$$
\frac {9.81 + b_{az}} {a_{z0}} = S =  \frac {-9.81 + b_{az}} {a_{z1}}，\\
...
$$
S a_{z0} - 9.81 = S \cdot b_{ax} = 
S a_{z01} + 9.81， \\
S a_{z0} - 9.81 = S a_{z1} + 9.81， \\
S (a_{z0} - S a_{z1}) = 2 \cdot 9.81
$$


$$
K_{33} = S  = \frac {2 \cdot 9.81} {a_{z0} - a_{z1}}
$$

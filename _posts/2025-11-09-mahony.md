...
$$
w = \begin{bmatrix} w_x \\ w_y \\ w_z \end{bmatrix}，R_{gyro} = \begin{bmatrix} R{11} && R{12} && R{13} \\ R{21} && R{22} && R{23} \\ R{31} && R{32} && R{33}  
\end{bmatrix}
$$
...
$$
w = \begin{bmatrix} w_x \\ w_y \\ w_z \end{bmatrix}，R_{gyro} = \begin{bmatrix} R{11}^{-1} && 0 && 0 \\ 0 && R{22}^{-1} && 0 \\
0 && 0 && R{33}^{-1} \end{bmatrix}
$$
...
$$
w = \begin{bmatrix} a_x \\ a_y \\ a_z \end{bmatrix}，K_{accel} =  \begin{bmatrix} K{11} && K{12} && K{13} \\ K{21} && K{22} && K{23} \\ K{31} && K{32} && K{33} \end{bmatrix}
$$

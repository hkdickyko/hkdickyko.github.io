(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports) :
		...
		(factory((global.MorphGeometry = global.MorphGeometry || {})));
	...
	function createMorphGeometry(p) {
		...
		*/
		...
		g.rCircHeight = p.rCircHeight !== undefined ? p.rCircHeight : function (u, v, t) {
			return 1
		};
		g.centerX = p.centerX !== undefined ? p.centerX : function (v, t) {
			return 0
		};
		g.centerY = p.centerY !== undefined ? p.centerY : function (v, t) {
			return v
		};
		g.centerZ = p.centerZ !== undefined ? p.centerZ : function (v, t) {
			return 0
		};
		g.unrollCover = p.unrollCover !== undefined ? p.unrollCover : function (v, t) {
			return 0
		};
		g.waffleDeep = p.waffleDeep !== undefined ? p.waffleDeep : function (u, v, t) {
			return 0
		};
		g.moveX = p.moveX !== undefined ? p.moveX : function (u, v, t) {
			return 0
		};
		g.moveY = p.moveY !== undefined ? p.moveY : function (u, v, t) {
			return 0
		};
		g.moveZ = p.moveZ !== undefined ? p.moveZ : function (u, v, t) {
			return 0
		};
		g.explode = p.explode !== undefined ? p.explode : function (t) {
			return 0
		};
		g.endCircAngle = p.endCircAngle !== undefined ? p.endCircAngle : function (v, t) {
			return 1
		};
		g.startCircAngle = p.startCircAngle !== undefined ? p.startCircAngle : function (v, t) {
			return 0
		};
		g.scaleCircAngle = p.scaleCircAngle !== undefined ? p.scaleCircAngle : function (u, t) {
			return u
		};
		g.topHeight = p.topHeight !== undefined ? p.topHeight : function (u, t) {
			return 1
		};
		g.bottomHeight = p.bottomHeight !== undefined ? p.bottomHeight : function (u, t) {
			return 0
		};
		g.scaleHeight = p.scaleHeight !== undefined ? p.scaleHeight : function (v, t) {
			return v
		};
		...
		g.materialCover = function () {
			return 1
		}; // default material index is 0.1 * 10 = 1
		g.materialBottom = function () {
			return 1
		}; // can be overwritten by fixedMatBottom (string of digits for faces)
		g.materialTop = function () {
			return 1
		}; // can be overwritten by fixedMatTop (string of digits for faces)

		if (p.materialCover !== undefined) g.materialCover = function (u, v, t) {
			return Math.floor(10 * p.materialCover(u, v, t))
		};
		if (p.materialBottom !== undefined) g.materialBottom = function (u, t) {
			return Math.floor(10 * p.materialBottom(u, t))
		};
		if (p.materialTop !== undefined) g.materialTop = function (u, t) {
			return Math.floor(10 * p.materialTop(u, t))
		};
	...
	function create() {
		...
		if (g.indexed) {
			...
			if (g.quadLine) {
				...
				g.quadLine = new THREE.Line(g.lineGeometry, new THREE.LineBasicMaterial({
					color: g.quadColor
				}));
	...
	function vertexFaceNumbersHelper(mesh, mode, size, color) {
		...
		var vertexNumbers = [];
		var faceNumbers = [];
		var materialDigits = new THREE.LineBasicMaterial({
			color: color
		});
		var geometryDigit = [];
		var digit = [];
